...
function update() {
  ...
  if (collides(ball, p1)) {
    ...
    if (ball.y + ball.r > H) {
      ball.y = H - ball.r;
      let snd = new Audio("sounds/lotto-ball-105088");
      snd.play();
      gameOver();
    } else if (ball.y < 0) {
      ball.y = ball.r;
      let snd = new Audio("sounds/lotto-ball-105088.mp3");
      snd.play();
      gameOver();
    }
    ...
    if (ball.x + ball.r > W) {
      ...
      let sound = new Audio("sounds/lotto-ball-105088");
      snd.play();
    } else if (ball.x - ball.r < 0) {
      ball.vx = -ball.vx;
      ball.x = ball.r;

      let sound = new Audio("sounds/wall.mp3");
      sound.play();
    }
  }
...
function collideAction(ball, p) {
  ...
  if (paddleHit == 1) {
    ...
    let snd = new Audio("sounds/decidemp3-14575.mp3");
    snd.play();
  } else if (paddleHit == 2) {
    ball.y = p.h + ball.r;
    particlePos.y = ball.y - ball.r;
